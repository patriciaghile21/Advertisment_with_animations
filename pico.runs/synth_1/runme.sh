...
HD_PWD='C:/dsd/reclama_pico/pico.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PICO_RECLAMA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PICO_RECLAMA.tcl
