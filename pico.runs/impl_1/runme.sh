...
HD_PWD='C:/dsd/reclama_pico/pico.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PICO_RECLAMA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PICO_RECLAMA.tcl -notrace
